...
- `workflow`: packages reusable workflow skills, including long-running goal management, SOP execution harnesses, prompt/strategy loops, explicit subagent orchestration, and standalone summaries.
