...
- `orchestrate-subagents`: user-requested Codex subagent orchestration with bounded delegation, evidence consolidation, failure handling, and parent-owned integration.
