...
- `cd backend && uv run python /Users/max/.codex/skills/.system/plugin-creator/scripts/validate_plugin.py /Users/max/Projects/codex-marketplace/plugins/doc-watcher`: validate plugin metadata with a Python environment that includes PyYAML.
