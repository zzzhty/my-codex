...
- Keep local Codex adaptation outside `skills/`: the `.codex-plugin` wrapper and Watcher metadata, version/cachebuster, this instruction file, the generated README, and repository-owned updater/checker/tests.
