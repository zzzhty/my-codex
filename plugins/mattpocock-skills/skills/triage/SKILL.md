...
These are canonical role names — the actual label strings used in the issue tracker may differ. Use the repo's documented mapping when present; if it is missing or ambiguous, ask the maintainer before changing labels.
