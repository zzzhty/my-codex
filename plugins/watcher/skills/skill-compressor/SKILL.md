...
Do not use it to redesign workflows, change safety/permission behavior, remove validation gates, or refactor deterministic scripts. Use `skill-maintainer` when Watcher skill-domain log evidence should produce a maintenance proposal instead of direct compression.
