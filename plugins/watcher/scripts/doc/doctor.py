...
class Doctor:
    ...
    def check_layout(self) -> None:
        ...
        for name in ("audit_repo.py", "generate_report.py", "commit_counter.py", "doctor.py"):
            self.check_file(REPO_ROOT / "scripts" / "doc" / name, f"doc script {name}")
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Check Watcher doc-domain plugin, config, and runtime basics.")
