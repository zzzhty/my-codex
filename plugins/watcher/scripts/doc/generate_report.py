#!/usr/bin/env python3
"""Generate a report-only Watcher doc audit summary for configured repos."""
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Write a report-only Watcher doc audit report under state reports/.")
