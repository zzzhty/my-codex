...
- [Universal Agent Skills Migration](universal-agent-skills-migration.md): draft long-running goal completing planning preflight for repository authority, explicit discovery profiles, Watcher decoupling, optional plugin distribution, and controlled cutover on the current Mac.
