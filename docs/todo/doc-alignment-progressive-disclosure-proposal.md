...
Status: proposal only. Do not edit `plugins/watcher/skills/doc-alignment/SKILL.md` from this artifact without a later source-edit pass, fresh oracle, independent review, and validation.
